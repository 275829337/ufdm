...
public class JkRSAUtils {
    ...
    public static String sign(byte[] data, String privateKey) throws Exception {
        byte[] keyBytes = JkBase64Util.decode(privateKey);
        ...
        return JkBase64Util.encode(signature.sign());
    }
    ...
    public static boolean verify(byte[] data, String publicKey, String sign)
            throws Exception {
        byte[] keyBytes = JkBase64Util.decode(publicKey);
        ...
        signature.update(data);
        return signature.verify(JkBase64Util.decode(sign));
    }
    ...
    public static String getPrivateKey(Map<String, Object> keyMap)
        ...
        return JkBase64Util.encode(key.getEncoded());
    }
