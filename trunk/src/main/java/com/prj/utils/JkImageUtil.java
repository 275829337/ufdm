...
public class JkImageUtil
{
	 public static void main(String[] args) {
	        ...
	        JkImageUtil.GenerateImage(strImg, "D:\\wangyc.jpg");
	        
	        // 测试从图片文件转换为Base64编码
	        System.out.println(JkImageUtil.GetImageStr("d:\\wangyc.jpg"));
	    }
	  ...
	  */
	  public static String GetImageStr(String imgFilePath) {
	      ...
	      return new String(JkBase64Util.encode(data));
	  }
	    ...
	    public static boolean GenerateImage(String imgStr, String imgFilePath) {
	        if (imgStr == null) // 图像数据为空
	            return false;
	        try {
	            byte[] bytes = JkBase64Util.decode(imgStr);
