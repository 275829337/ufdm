...
public class JkDesUtil
{
	...
	public static String DesEncrypt(String strMing,String strKey,String strKeyType,String strIvValue)
	{
		try
		{
			...
			String strMi = new String(JkBase64Util.encode(byteFina));
	...
	public static String DesDecrypt(String strMi,String strKey,String strKeyType,String strIv)
	{
		try
		{
			...
			// 转成BASE64
			byte [] byteFina = cipher.doFinal(JkBase64Util.decode(strMi));
	...
	public static void main(String[] args) {
		...
		String str3Des = JkDesUtil.TripleDesEncrypt("admin",pass,null,null);
		System.out.println("3DES 加密："+str3Des); 
		System.out.println("dDES 解密："+JkDesUtil.TripleDesDecrypt(str3Des,pass,null,null));
