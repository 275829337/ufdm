...
<body>
	...
	<div class="container">
		...
		<div class="row" style="float: none;">
			...
			<label class="col-md-2" >图片2:</label>
			<div class="col-md-2" style="float: left;">
			...
			<label class="col-md-2" >图片3:</label>
			<div class="col-md-2" style="float: left;">
		...
		<h3>处理信息</h3>
		<div class="row">		
			<label class="col-md-2" for="woStatusCode">处理状态:</label>
			<div class="col-md-2">
					<select id="woStatusCode" class="form-control">
			...
			<label class="col-md-2" for="replyType">是否公开:</label>
			<div class="col-md-2">
		...
		<div class="row">		
			<label class="col-md-2" for="processContent">处理内容:</label>
			<div class="col-md-2">
					<textarea rows="5" cols="80" id="processContent"></textarea> 
			</div>
		</div>
	...
	$("#commit").bind("click",function(){
		$.ajax({
			type: "POST",
			url: '<spring:url value="/tenwok/doDealWorkOrder"/>',
			data:{
				version:0,
				woId:$("#workOrderId").val(), 
				woStatusCode:$("#woStatusCode").val(), 
				woStatusDesc:$("#woStatusCode").find('option:selected').text(), 
