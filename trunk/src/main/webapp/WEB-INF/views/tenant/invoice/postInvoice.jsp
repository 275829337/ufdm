...
<body>
	...
	<form id="submitForm" class="form-horizontal">
		...
		<div class="col-sm-10">
		    <input type="text" class="form-control" id="expressCompany" value="${tenantInvoiceLog.expressCompany}" />
		</div>
		<label class="control-label col-sm-2" >快递单号</label>
		<div class="col-sm-10">
		    <input type="text" class="form-control" id="expressNumber" value="${tenantInvoiceLog.expressNumber}"  /> 
		</div>
		
		<label class="control-label col-sm-2" for="mobile">邮寄状态</label>
		<div class="col-sm-8">
			<input type="radio" name="invoicestatusCode" value="3" />已邮寄
...
<script>
	...
	$("#commit").bind("click",function(){
		...
		if(invoicestatusCodeValue==3){
			invoicestatusCodeText = '已邮寄';
		}
