...
<body>
	...
	<form id="submitForm" class="form-horizontal">
		...
		<div class="col-sm-10">
		    <input type="text" class="form-control" id="invoicecode" value="${tenantInvoiceLog.invoicecode}" /> 
		</div>
		<label class="control-label col-sm-2" >发票号</label>
		<div class="col-sm-10">
		    <input type="text" class="form-control" id="invoiceno" value="${tenantInvoiceLog.invoiceno}"  /> 
		</div>
		
		<label class="control-label col-sm-2" for="mobile">审核状态</label>
		<div class="col-sm-8">
			<input type="radio" name="invoicestatusCode" value="2" />已开票未邮寄
...
<script>
	...
	$("#commit").bind("click",function(){
		...
		if(invoicestatusCodeValue==2){
			invoicestatusCodeText = '已开票未邮寄';
		}
