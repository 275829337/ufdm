...
<body>
	...
	<div class="navbar-btn">
		<button type="button" class="btn btn-danger col-sm-offset-3" id="cancel" >关闭</button>
		<button type="button" class="btn btn-success col-sm-offset-1" id="submit">更新</button>
	</div>
	</form>
